...
namespace Canducci.Pagination.Mvc
{
    ...
    [HtmlTargetElement("pagination", Attributes = PaginationTotalPages)]
    [HtmlTargetElement("pagination", Attributes = PaginationLabelTotalPages)]
    public class PaginatedTagHelper : TagHelper
    {
        ...
        private const string PaginationTotalPages = "pagination-total-pages";
        private const string PaginationLabelTotalPages = "pagination-label-total-pages";
        #endregion
        ...
        [HtmlAttributeName(PaginationTotalPages)]
        public bool TotalPages { get; set; } = false;

        [HtmlAttributeName(PaginationLabelTotalPages)]
        public string LabelTotalPages { get; set; } = "Page";
        #endregion
        ...
        #endregion
        #region TotalPages
        internal TagHelperOutput TotalPagesView(TagHelperOutput output)
        {
            if (TotalPages)
            {
                TagBuilder tagBuilder = CreateTagBuilder(output, Paginated.PageCount , Paginated.PageCount + " " + LabelTotalPages, CssClassAchor);
                output.Content.AppendHtml(tagBuilder, CssClassLiDisabled + " " + CssClassLi);
            }
            return output;
        }
        #endregion
